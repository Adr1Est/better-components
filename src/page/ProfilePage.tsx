    ...
    <main className="w-full flex-1 flex justify-center items-start">
      <div className="w-full md:w-200 items-center flex flex-col gap-2 mt-3">
        <div className="w-full flex flex-col md:flex-row gap-2">
          <CustomTextField label="EMAIL" data={data.user.email} type="email" disabled />
          <CustomTextField label="NOMBRE_DE_USUARIO" data={data.user.username} type="text" disabled />
        </div>
        {
          data.user.apiKey
